                                ...
                                <table id="example" class="table table-striped table-bordered" >
                                    ...
                                    <tbody>
                                         <tr>
                                             ...
                                             <td>{{$newsUpdate->id ?? ''}}</td>
                                             <td>{{$newsUpdate->heading ?? '' }}</td>
                                             <td>{{$newsUpdate->heading1 ?? '' }}</td>
                                             <td>{{$newsUpdate->title ?? ''}}</td>
                                             <td>{{$newsUpdate->description ?? ''}}</td>

                                             <td>{{$newsUpdate->title2 ?? ''}}</td>
                                             <td>{{$newsUpdate->description2 ?? ''}}</td>

                                             <td>{{$newsUpdate->title3 ?? ''}}</td>
                                             <td>{{$newsUpdate->description3 ?? ''}}</td>

                                             <td><img src="{{asset($newsUpdate->image ?? '')}}" width="40"
                                             class="img-circle" /> </td>

                                           <td>
                                               <a href="{{route('news-update.edit',$newsUpdate->id ?? '')}}" style="margin: 2px;" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i>
                                               </a>
                                            </td>
