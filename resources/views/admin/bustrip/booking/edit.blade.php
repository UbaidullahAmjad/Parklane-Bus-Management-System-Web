                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password"
                                name="password_confirmation" required class="form-control" value="{{$user->password}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pickup_location" name="pickup_location" placeholder="pickup_location" value="{{$bustrip->pickup_location}}">
                                    </div>
                                </div>
                                 <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Drop Off Location</label>
                                        <input type="text" class="form-control" id="drop_off_location" name="drop_off_location" placeholder="drop_off_location" value="{{$bustrip->drop_off_location}}">
                                    </div>
                                </div>
                                 <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1"> Pickup Date</label>
                                        <input type="date" class="form-control" id="pickup_date" name="pickup_date" placeholder="pickup_date" value="{{$bustrip->pickup_date}}">
                                    </div>
                                </div>
                                 <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Pickup Time</label>
                                        <input type="time" class="form-control" id="pickup_time" name="pickup_time" placeholder="pickup_time" value="{{$bustrip->pickup_time}}">
                                    </div>
                                </div>
                                 <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Drop Off Date</label>
                                        <input type="date" class="form-control" id="drop_off_date" name="drop_off_date" placeholder="drop_off_date" value="{{$bustrip->drop_off_date}}">
                                    </div>
                                </div>
                                 <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Drop Off Time</label>
                                        <input type="time" class="form-control" id="drop_off_time" name="drop_off_time" placeholder="drop_off_time" value="{{$bustrip->drop_off_time}}">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Seat No</label>
                                        <input type="number" class="form-control" id="seat" name="seat" placeholder="No of Seat" value="{{$booking->seat_no}}">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">Seat No</label>
                                        <input type="text" class="form-control" id="booking_no" name="booking_no" placeholder="No of Seat" value="{{$booking->booking_no}}">
                                    </div>
                                </div>
