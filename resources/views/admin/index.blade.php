    ...
    <div class="side-app">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 ">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title font-weight-normal">Active Trip</h3>
                        <div class="card-options"> </div>
                    </div>
                    <div class="card-body ">
                        <h2 class="text-dark  mt-0">{{$activeTrip}}</h2>
                        <div class="progress progress-sm mt-0 mb-2">
                            <div class="progress-bar bg-primary w-{{$activeTrip}}" role="progressbar"></div>
                        </div>
            ...
            <div class=" col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title font-weight-normal">Active Bus</h3>
                        <div class="card-options"> </div>
                    </div>
                    <div class="card-body ">
                        <h2 class="text-dark  mt-0">{{$activeBus}}</h2>
                        <div class="progress progress-sm mt-0 mb-2">
                            <div class="progress-bar bg-secondary w-{{$activeBus}}" role="progressbar"></div>
                        </div>
                        <div class=""><i class="fa fa-caret-down text-danger mr-1"></i></div>
                    </div>
                </div>
            </div>
            <div class=" col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title font-weight-normal">Total Trip</h3>
                        <div class="card-options"></div>
                    </div>
                    <div class="card-body ">
                        <h2 class="text-dark  mt-0">{{$totalTrip}}</h2>
                        <div class="progress progress-sm mt-0 mb-2">
                            <div class="progress-bar bg-success w-{{$totalTrip}}" role="progressbar"></div>
                        </div>
                        <div class=""><i class="fa fa-caret-down text-danger mr-1"></i></div>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 ">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title font-weight-normal">Total Bus</h3>
                        <div class="card-options">  </div>
                    </div>
                    <div class="card-body ">
                        <h2 class="text-dark  mt-0">{{$totalBus}}</h2>
                        <div class="progress progress-sm mt-0 mb-2">
                            <div class="progress-bar bg-info w-{{$totalBus}}" role="progressbar"></div>
                        </div>
                        <div class=""><i class="fa fa-caret-up text-success mr-1"></i></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 ">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title font-weight-normal">Reports</h3>
                        <div class="card-options">  </div>
                    </div>
                    <div class="card-body ">
                        <h2 class="text-dark  mt-0"></h2>
                        <div class="progress progress-sm mt-0 mb-2">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-12 col-md-12" style="display: none">
                <div class="card text-center">
                    <div class="card-body">
                        <img src={{asset(Auth::user()->avatar)}} class="mb-0 h-240" alt="img">
