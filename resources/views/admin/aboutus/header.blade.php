                                ...
                                <table id="example" class="table table-striped table-bordered" >
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td><img src="{{ asset($aboutus->bg_image) }}" alt="user" width="40"
                                                class="img-circle" /> </td>
                                           <td style=" display: inline-flex">
                                                <a href="{{route('abouts.editing',$aboutus->id)}}" style="margin: 2px;" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                                <!--<a href="{{route('abouts.deleted',$aboutus->id)}}" style="margin: 2px;" class="btn btn-xs btn-primary"><i class="fa fa-trash"></i></a>-->
