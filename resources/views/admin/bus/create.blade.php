                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        is-invalid @enderror" id="name" name="name" placeholder="Bus Name" >
                                        @error('name')
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('no_of_seat')
                                             is-invalid
                                        @enderror" name="no_of_seat"  placeholder="Number of seat" >
                                        @error('no_of_seat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    is-invalid
                                    @enderror"  name="plate_no" placeholder="plate no" >
                                    @error('plate_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    is-invalid
                                   @enderror" id="inputPassword4" name="base_rate" placeholder="base rate" >
                                    @error('base_rate')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
