<div class="app-header1 header py-1 d-flex" id="printPageButton">
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{route('dashboard')}}">
                <img src="{{asset('assets/images/logo.svg')}}" class="header-brand-img" alt="Lmslist logo" style="width: 75px">
            </a>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                {{-- <div class="dropdown d-none d-md-flex country-selector">
                    <a href="#" class="d-flex nav-link leading-none" data-toggle="dropdown">
                        <img src="{{asset('admin/assets/images/flags/us_flag.jpg')}}" alt="img" class="avatar avatar-xs mr-1 align-self-center">
                        <div>
                    ...
                    <div class="language-width dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src="{{asset('admin/assets/images/flags/french_flag.jpg')}}"  alt="flag-img" class="avatar  mr-3 align-self-center" >
                            <div>
                        ...
                        {{-- <a href="#" class="dropdown-item d-flex pb-3">
                            <img src="{{asset('admin/assets/images/flags/spain_flag.jpg')}}"  alt="flag-img" class="avatar  mr-3 align-self-center" >
                            <div>
                                <strong>Spain</strong>
                            </div>
                        </a>
                ...
                <div class="dropdown ">
                    <a href="#" class="nav-link pr-0 leading-none user-img" data-toggle="dropdown">
                        <img src="{{asset(Auth::user()->avatar)}}" alt="profile-img" class="avatar avatar-md brround">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
                        <a class="dropdown-item" href="{{url('profile-user')}}">
                            ...
                            <form action="{{route('logout')}}" method="post">
                                @csrf
                                <x-responsive-nav-link :href="route('logout')" style="margin:2px"
