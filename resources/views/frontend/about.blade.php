...
@section('content')
<!-- Inner Banner -->
	<section class="banner inner-banner" style="background: url({{asset($aboutus->bg_image)}});">
		<div class="item">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="heading left-heading">
						<span>{{$aboutus->sub_title}}</span>
						<h2>{{$aboutus->main_title}}</h2>
						<p>{{$aboutus->description}}.</p><br>
						<a href="{{$aboutus->descover_link}}" class="default-btn">Discover More</a>
					</div>
				</div>
				<div class="col-md-6 col-sm-12">
	...
	<section class="about-social-media">
		<div class="container">
			<div class="heading text-center">
				<span>{{$sociallink->heading}}</span>
				<h2>{{$sociallink->social_title}}</h2>
			</div>
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="media">
						<span class="about-social-icon"><i class="fab fa-facebook-f"></i></span>
						<div class="media-body">
						  <h5><a href="{{$sociallink->social_link1}}">FACEBOOK</a></h5>
						  <p>{{$sociallink->social_description1}}.</p>
						</div>
					  </div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="media">
						<span class="about-social-icon"><i class="fab fa-twitter"></i></span>
						<div class="media-body">
						  <h5><a href="{{$sociallink->social_link2}}">TWITTER</a></h5>
						  <p>{{$sociallink->social_description2}}.</p>
						</div>
					  </div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="media">
						<span class="about-social-icon"><i class="fab fa-youtube"></i></span>
						<div class="media-body">
						  <h5><a href="{{$sociallink->social_link4}}">YOUTUBE</a></h5>
						  <p>{{$sociallink->social_description4}}.</p>
						</div>
					  </div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="media">
						<span class="about-social-icon"><i class="fab fa-google-plus-g"></i></span>
						<div class="media-body">
						  <h5><a href="{{$sociallink->social_link3}}">GOOGLE +</a></h5>
						  <p>{{$sociallink->social_description4}}.</p>
						</div>
					  </div>
				</div>
